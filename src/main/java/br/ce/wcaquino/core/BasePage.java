...
public class BasePage {
	...
	public WebElement obterCelula(String colunaBusca, String valor, String colunaResultado, String idTabela){
...
//		List<WebElement> colunas = tabela.findElements(By.xpath(".//th"));
		List<WebElement> colunas = tabela.findElements(By.xpath("./thead/tr/th"));
		int idColuna = -1;
